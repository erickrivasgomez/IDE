...
public class Parser implements ParserConstants {
 ...
 System.out.print("Entrada a ciclo ");
    if (jj_2_16(2)) {
      jj_consume_token(DO);
                                             {System.out.print("DO ");}
  ...
  static final public void cond() throws ParseException {
               Token actual; Object variable=null; Object compara=null; String signo="";
    jj_consume_token(PAR1);
    if (jj_2_31(2)) {
      if (jj_2_19(2)) {
        actual = jj_consume_token(CAD);
                            variable = actual.image;variable = tabla.getValor(actual.image);System.out.println(variable);
      } else if (jj_2_20(2)) {
        actual = jj_consume_token(NUM);
                                                                                                                                          variable = actual.image;System.out.println(variable);
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
      ...
      if (jj_2_27(2)) {
        actual = jj_consume_token(CAD);
                            compara = actual.image;compara = tabla.getValor(actual.image+"");System.out.println(compara);
      } else if (jj_2_28(2)) {
        actual = jj_consume_token(NUM);
                                                                                                                                          compara = actual.image;System.out.println(compara);
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
 ...
 System.out.println("Salida de ciclo FOR.");
  ...
  static final public void declaracion() throws ParseException {
                     Token actual;String nombre;String tipo;Object valor="";
    if (jj_2_59(2)) {
     System.out.print("Declaracion: entero ");
      jj_consume_token(INT);
      actual = jj_consume_token(CAD);
                         System.out.print(actual.image);nombre = actual.image;
      label_2:
      while (true) {
        if (jj_2_47(2)) {
          ;
  ...
  static final public int valor() throws ParseException {
              Token actual; int num;
    actual = jj_consume_token(NUM);
                   System.out.print(" "+actual.image); {if (true) return Integer.parseInt(actual.image);}
  ...
  static final public void switchcase() throws ParseException {
                     Token actual; Object variable; Object compara;
    jj_consume_token(SWITCH);
                 System.out.println("Entra a switch");
    jj_consume_token(PAR1);
    actual = jj_consume_token(CAD);
                                                                             System.out.println("Se compara: "+actual.image+"="+tabla.getValor(actual.image+""));variable = actual.image;variable = tabla.getValor(actual.image+"");
    jj_consume_token(PAR2);
    jj_consume_token(LLA1);
    label_8:
    while (true) {
      ...
      if (jj_2_67(2)) {
        ...
        actual = jj_consume_token(FLOTANTE);
                                                                                                                                                                                                                                                                                                                     compara = actual.image;
      } else if (jj_2_69(2)) {
        actual = jj_consume_token(CARACTER);
                                                                                                                                                                                                                                                                                                                                                                  compara = actual.image;
        ...
        actual = jj_consume_token(NUM);
                                                                                                                                                                                                                                                                                                                                                                                                          compara = actual.image;evaluarSwitch(variable, compara);
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
  ...
  static final public void evaluarSwitch(Object variable, Object compara) throws ParseException {
        String uno, dos;
        uno = variable+"";
        dos = compara+"";
        System.out.print("\u005ct("+variable+"=="+compara+")");
        if(uno.equals(dos)){
            System.out.println("true");
        }
        else {
  ...
  static final public void asignacion() throws ParseException {
                     Token actual;String nombre;Object valor=null;
    actual = jj_consume_token(CAD);
  ...
  static private boolean jj_3_58() {
    if (jj_scan_token(FLOT)) return true;
    return false;
  }
  ...
  static final private JJCalls[] jj_2_rtns = new JJCalls[73];
